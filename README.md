...
wq_workflow_v2.py → launchd (后台守护，崩溃自愈) → 飞书 Bot 推送
     ...
     │      └── v3.19: SC 调参优先中性化降维 (SECTOR → SUBINDUSTRY) 再换字段对
...
│   ├── v3.19: SC 中性化降维 — SC fail 时优先 SECTOR/SUBINDUSTRY 中性化重试同表达式，失败再换字段对
├── scripts/
